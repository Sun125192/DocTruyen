...
@section('content')
    <div class="container mt-2">
        <h1 class="text-center">Quản lý Thêm mới Truyện tranh</h1>
    </div>
    <div class="container">
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            <div class="col">
                <form name="frmThemMoi" id="frmThemMoi" method="post"
                    action="{{ route('admin.truyen-tranh.danh-sach-truyen-tranh.create') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <div class="form-group col">
                            <label for="truyen_ma">Mã truyện tranh</label>
                            <input type="text" class="form-control" id="truyen_ma" name="truyen_ma"
                                placeholder="Mã truyện tranh" value="{{ old('truyen_ma') }}">
                            @error('truyen_ma')
                        ...
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="truyen_ten" name="truyen_ten"
                                placeholder="Tên truyện tranh" value="{{ old('truyen_ten') }}">
                            @error('truyen_ten')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="truyen_theloai" name="truyen_theloai"
                                placeholder="Thể loại truyện tranh" value="{{ old('truyen_theloai') }}">
                        ...
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="truyen_tacgia" name="truyen_tacgia"
                                placeholder="Tác giả truyện tranh" value="{{ old('truyen_tacgia') }}">
                            @error('truyen_tacgia')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
