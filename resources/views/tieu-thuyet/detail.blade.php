                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="anime__details__pic set-bg"
                            data-setbg="{{ asset('storage/uploads/tieu-thuyet/' . $dataTruyenRow['truyen_hinhdaidien']) }}">
                            ...
                            <tbody>
                                @foreach ($dataChuong as $chuong)
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="{{ url('tieu-thuyet', ['truyen_id' => $chuong['truyen_id'], 'chuong_so' => $chuong['chuong_so'], 'tong_so_chuong' => count($dataChuong)]) }}">
                                                {{ $chuong['chuong_ten'] }}
                                            </a>
                                        </td>
                                    </tr>
