...
$(document).ready(function() {
    $(".read-more-button").click(function() {
        var paragraphContainer = $(this).closest("td").find(".paragraph-container");
        paragraphContainer.toggleClass("open");
        
        if (paragraphContainer.hasClass("open")) {
            $(this).text("Thu gọn");
        } else {
            $(this).text("Xem thêm");
        }
...
$(document).ready(function() {
    $(".read-more-button").click(function(e) {
        ...
        $(this).closest(".paragraph-container").toggleClass("open");
    });
});