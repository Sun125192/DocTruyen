...
{
    public function danhSachTruyenTranh()
    {
        $dataDanhSachTruyenTranh = Truyen::loai(2)->get();
        return view('admin.truyen-tranh.danh-sach-truyen-tranh', compact('dataDanhSachTruyenTranh'));
    }

    public function truyenTranhCreate()
    {
        return view('admin.truyen-tranh.them-truyen-tranh');
    }
    ...
    public function create(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('admin.truyen-tranh.danh-sach-truyen-tranh')->with('success', 'Thêm mới truyện tranh thành công.');
        }
    ...
    public function update(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            if (isset($_FILES['truyen_hinhdaidien']) && $_FILES['truyen_hinhdaidien']['error'] == 0) {
                $upload_dir = public_path('storage/uploads/truyen-tranh/'); // Thay đổi đường dẫn lưu hình
            ...
            $truyen->truyen_loai = 2; // #2-Truyện tranh
            ...
            return redirect()->route('admin.truyen-tranh.danh-sach-truyen-tranh')->with('success', 'Cập nhật truyện tranh thành công.');
        }
    ...
    public function delete($truyen_id)
    {
        ...
        if (!$truyen) {
            ...
            return redirect()->route('admin.truyen-tranh.danh-sach-truyen-tranh')->with('error', 'Không tìm thấy truyện.');
        }
        ...
        if ($chuongs->isEmpty()) {
            ...
            $oldFilePath = public_path('storage/uploads/truyen-tranh/') . $truyen->truyen_hinhdaidien;
            ...
            return redirect()->route('admin.truyen-tranh.danh-sach-truyen-tranh')->with('success', 'Xóa truyện và dữ liệu liên quan thành công.');
        }
    }
}
